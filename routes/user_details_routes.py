...
user_details_bp.route('/user_details', methods=['PUT'])(user_details_controller.update_user_details)
user_details_bp.route('/user_details', methods=['GET'])(user_details_controller.get_user_details)
