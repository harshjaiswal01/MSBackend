...
content_item_bp.route('/vision-boards/<int:vision_board_id>/content', methods=['GET'])(content_item_controller.get_content_items)
content_item_bp.route('/vision-boards/<int:vision_board_id>/custom-article', methods=['POST'])(content_item_controller.add_custom_article)
